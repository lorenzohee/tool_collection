...
module.exports  = {
    base: 'https://www.com', // base url of the website
    urls: [
        'https://www.com' // URLs to scan (works only if autoCrawl is false)
    ],
    strictPresence: 'https://www.com', // Crawl links only if this is present
